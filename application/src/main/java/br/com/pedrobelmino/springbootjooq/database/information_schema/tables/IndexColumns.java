...
import br.com.pedrobelmino.springbootjooq.database.information_schema.tables.records.IndexColumnsRecord;
...
public class IndexColumns extends TableImpl<IndexColumnsRecord> {
    ...
    private IndexColumns(Name alias, Table<IndexColumnsRecord> aliased, Field<?>[] parameters) {
    ...
    public <O extends Record> IndexColumns(Table<O> child, ForeignKey<O, IndexColumnsRecord> key) {
